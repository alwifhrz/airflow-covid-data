...
class Transformer():
    ...
    def create_dimension_case(self):
        df = self.get_data_from_mysql()
        column_start = ['suspect_diisolasi','suspect_discarded','closecontact_dikarantina','closecontact_discarded','probable_diisolasi','probable_discarded','suspect_meninggal','closecontact_meninggal','probable_meninggal']
    ...
    def create_province_daily(self):
        ...
        column_start = ['tanggal','kode_prov','suspect_diisolasi','suspect_discarded','closecontact_dikarantina','closecontact_discarded','probable_diisolasi','probable_discarded','suspect_meninggal','closecontact_meninggal','probable_meninggal']
    ...
    def create_district_daily(self):
        ...
        column_start = ['tanggal','kode_kab','suspect_diisolasi','suspect_discarded','closecontact_dikarantina','closecontact_discarded','probable_diisolasi','probable_discarded','suspect_meninggal','closecontact_meninggal','probable_meninggal']
